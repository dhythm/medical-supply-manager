          ...
          <form action={createNegotiationAction} className="grid gap-3 md:grid-cols-2 xl:grid-cols-6">
            <label className="grid gap-1 text-xs xl:col-span-2">
              ...
              <select
                ...
                required
                className="border-input bg-background h-9 rounded-lg border px-3"
              >
                  ...
                  <section>
                    ...
                    {!closed ? (
                      <form action={setDemandAction} className="mt-4 flex flex-wrap items-end gap-2">
                        ...
                        <label className="grid w-28 gap-1 text-xs">
                          数量
                  ...
                  <section>
                      ...
                      {item.quotes.map((quote) => (
                        ...
                        >
                          ...
                          {quote.minimumQuantity ? (
                            <span className="text-muted-foreground text-xs">最低{quote.minimumQuantity}</span>
                          ) : null}
                          {quote.isSelected ? (
                            <Badge>
                    ...
                    {selectedQuote && !closed ? (
                      <form
                        ...
                        className="border-primary/20 bg-primary/5 mt-4 flex flex-wrap items-end gap-2 rounded-lg border p-3"
                      >
                        <input type="hidden" name="negotiationId" value={item.id} />
                        <label className="grid gap-1 text-xs">
                          契約開始日
